...
/**
 * <!-- globalinfo-start --> A wrapper class for the Snowball stemmers. Only available if the Snowball classes are in the classpath.<br/>
...
public class SnowballStemmer implements Stemmer, OptionHandler {
	 ...
	 * 
	 * @param lineLength
	 *            the max line length, before a linefeed is inserted (0 is unlimited)
	 * @param indention

...
*//**
 * Class for transforming Instances objects into <a href="http://www.json.org/" target="_blank">JSON</a> objects and vice versa. Missing values get stored as "?".
 * 
 ...
 * 
 * @param att
 *            the JSON object to turn into an Attribute
 * @param classAtt
 *            for storing whether the attribute is the class attribute
 ...
 * 
 * @param inst
 *            the JSON object to turn into an Instance
 * @param data
 *            the data so far (only used for header information)
 ...
 * @param onlyHeader
 *            whether to retrieve only the header

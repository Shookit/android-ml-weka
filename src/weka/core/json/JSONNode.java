...
*//**
 * Container class for storing a <a href="http://www.json.org/" target="_blank">JSON</a> data structure.
 * 
 ...
 *            the primitive value
 * @param type
 *            the type of the node, null for primitives
 */
/*
 ...
 *            the value
 * @param type
 *            the node type, null for primitives
 * @return the new node, or null if none added
 */
/*
 ...
 * 
 * @param o
 *            the object to process (only strings get processed)

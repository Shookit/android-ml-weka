...
public abstract class AbstractEvaluationMetric implements Serializable {
	...
	/**
	 * Get a list of the names of the statistics that this metrics computes. E.g. an information theoretic evaluation measure might compute total number of bits as well as avergate bits/instance
	 * 
	 ...
	 * 
	 * @param statName
	 *            the name of the statistic to compute the value for
	 * @return the computed statistic or Utils.missingValue() if the statistic can't be computed for some reason
	 */

...
public abstract class NeuralConnection implements Serializable, RevisionHandler {
	 ...
	 * 
	 * @param n
	 *            The connection number to get the weight for, -1 if The threshold weight should be returned.
	 * @return This function will default to return 1. If overridden, it should return the value for the specified connection or if -1 then it should return the threshold value. If no value exists for the specified connection, NaN will be returned.
	 */
	...
	*/
	 ...
	 * @param n
	 *            The connection number at the other end, -1 if all the connections to this unit should be severed.
	 ...
	 * @param t
	 *            The target unit.
	 * @return True if the units were disconnected, false if they weren't (probably due to there being no connection).
	 */

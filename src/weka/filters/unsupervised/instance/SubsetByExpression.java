...
/**
 * <!-- globalinfo-start --> Filters instances according to a user-specified expression.<br/>
 * <br/>
 * Grammar:<br/>
 * <br/>
...
public class SubsetByExpression extends SimpleBatchFilter {
	 ...
	 * 
	 * @return true this filter may remove (consume) input instances after the first batch has been completed.
	 */
	@Override
	 ...
	 * 
	 * @return true if the filter should be applied to instances that arrive after the first (training) batch has been processed.
	 */

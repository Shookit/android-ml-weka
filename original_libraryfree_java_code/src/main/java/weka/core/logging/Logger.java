...
public abstract class Logger implements RevisionHandler {
	 ...
	 * 
	 * @return the classname (= [0]), the method (= [1]) and the line number (= [2]) that generated the logging event
	 */
	...
	/**
	 * Performs the actual logging. Actual logger implementations must override this method.
	 * 
	 * @param level
